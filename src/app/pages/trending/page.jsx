...
export default function Trending() {
  ...
  return (
    <div className='w-11/12 mx-auto pb-10'>
        <div className='w-36 justify-center mx-auto flex'>
            <FaFire className='w-6 h-6 text-red-600'/> <h2 className='text-yellow-400 font-semibold text-xl text-center'>~Trending     ~</h2>
        </div>
          ...
          loading?(
            ...
            <div className='flex gap-6'>
            {
                books.map(book=>{
                  ...
                  <Link href={`/trending/${book.id}`}>
                  <div className='bg-gray-100 p-2 font-semibold relative z-50'>
